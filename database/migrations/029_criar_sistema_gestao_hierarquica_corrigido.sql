-- Migration CORRIGIDA para criar sistema hierárquico de gestão Setor > Serviços > SOPs
-- O Consultor - Sistema Operacional Empresarial
-- Esta versão remove Foreign Keys problemáticas para evitar erros de instalação

-- 1. Tabela para estruturas organizacionais permanentes
