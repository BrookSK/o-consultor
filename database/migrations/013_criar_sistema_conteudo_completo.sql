...
CREATE TABLE IF NOT EXISTS marcas (
    ...
    diferenciais_competitivos TEXT NULL,
    concorrentes TEXT NULL,
    objetivos_conteudo JSON NULL,
    tom VARCHAR(50) NULL,
    arquetipo VARCHAR(50) NULL,
    palavras_usa TEXT NULL,
    palavras_nunca TEXT NULL,
    formatos_preferenciais JSON NULL,
    paleta_cores JSON NULL,
    fonte_principal VARCHAR(100) NULL,
    fonte_secundaria VARCHAR(100) NULL,
    estilo_visual TEXT NULL,
    direcao_foto VARCHAR(50) NULL,
