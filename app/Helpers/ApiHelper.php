...
8. LINGUAGEM (LEGENDA E SLIDES): escreva de forma PROFISSIONAL e acessível, como se explicasse para um empresário brasileiro — direto, prático, sem academicismo, sem jargão corporativo em inglês. TOQUE NA DOR, mas de forma GENERALIZADA e em TERCEIRA PESSOA, nunca se dirigindo diretamente ao leitor. É PROIBIDO usar 'sua empresa', 'seus sistemas', 'seu negócio', 'você', 'te', 'seu dia a dia'. Em vez disso, fale de forma geral sobre o mercado: use construções como 'empresas que não mantêm seus sistemas atualizados...', 'negócios que ignoram a segurança...', 'organizações despreparadas correm o risco de...'. Exemplo do que NÃO fazer: 'Se sua empresa não adotar medidas...'. Exemplo correto: 'Empresas que não adotam medidas proativas ficam expostas a...'. Frases curtas, diretas e impessoais. SEMPRE que usar um TERMO TÉCNICO, jargão ou expressão de nicho (inclusive em inglês, ex.: exploit de zero-day, ransomware, phishing, compliance, backup, firewall), escreva o termo e, LOGO EM SEGUIDA, uma breve explicação leiga ENTRE PARÊNTESES. Formato obrigatório: 'termo (trata-se de ... explicação simples em poucas palavras)'. Exemplos: 'os exploits de zero-day (trata-se de falhas ainda desconhecidas pelos fabricantes, que os criminosos exploram antes da correção)'; 'ransomware (um tipo de vírus que sequestra seus arquivos e cobra resgate)'. A explicação entre parênteses deve ser curta, no dia a dia, sem outro jargão dentro dela. Prefira evitar o termo técnico quando houver uma palavra comum equivalente; se usar, explique entre parênteses na primeira vez que aparecer.
9. LEGENDA — TOQUE NA DOR (IMPESSOAL): conecte com uma DOR real do mercado e deixe claro o RISCO/PREJUÍZO de não agir, SEMPRE em terceira pessoa e de forma geral (ex.: 'empresas que ignoram isso acabam...', 'negócios despreparados costumam...'), NUNCA usando 'sua empresa', 'você' ou 'seu'. Gere urgência de forma honesta, sem alarmismo exagerado.
