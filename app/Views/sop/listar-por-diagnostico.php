        ...
        <div class="bg-gray-50 px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2 text-sm text-gray-500">
                            ...
                            <span><?= $setor['total_servicos'] ?> serviços</span>
                            <span class="text-green-600"><?= $setor['total_sops'] ?> SOPs</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <?php if ($setor['total_sops'] == $setor['total_servicos'] && $setor['total_servicos'] > 0): ?>
                    <span class="px-3 py-1 bg-green-100 text-green-700 text-sm rounded-full font-medium">✓ Completo</span>
                    <?php elseif ($setor['total_sops'] > 0): ?>
                    <span class="px-3 py-1 bg-yellow-100 text-yellow-700 text-sm rounded-full font-medium">⚠ Parcial (<?= $setor['total_sops'] ?>/<?= $setor['total_servicos'] ?>)</span>
                    <?php else: ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="border border-gray-200 rounded-lg p-4 hover:border-blue-300 hover:bg-blue-50 transition cursor-pointer"
                    ...
                    <div class="flex items-center justify-between mb-3">
                        <code class="text-xs font-mono bg-gray-100 px-2 py-1 rounded"><?= htmlspecialchars($servico['codigo_servico']) ?></code>
                        
                        <?php
                        switch($servico['status_final']) {
                            case 'mapeado':
                    ...
                    <!-- Nome e Categoria -->
                    <h3 class="font-medium text-gray-800 mb-2 leading-tight"><?= htmlspecialchars($servico['nome_servico']) ?></h3>
                    
                    <div class="flex items-center justify-between text-xs text-gray-500">
                        <span class="px-2 py-1 bg-purple-100 text-purple-700 rounded"><?= ucfirst($servico['categoria']) ?></span>
...
<!-- FALLBACK: Arquitetura Tradicional (manter para compatibilidade) -->
<!-- [resto do código da arquitetura tradicional permanece inalterado] -->

<!-- Se não existem SOPs ainda -->
<div class="text-center py-12">
